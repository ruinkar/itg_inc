...
<div class="form-group  has-feedback">
    <div>
        <input type="text" name="title" required="" value="<%=article.getTitle() %>" class="form-control" id="title" />
    </div>
</div>

<div class="form-group  has-feedback">
    <div>
        <input type="text" name="tagString" value="" placeholder="Tags," data-role="tagsinput" class="form-control" id="tagString" />
    </div>
</div>

<div class="form-group  has-feedback">
    
        <textarea name="acontent" id="summernote" rows="20" class="form-control input-block-level"><%=article.getAcontent()%></textarea>
    

</div>

<input type="hidden" name="content.textType" value="HTML" id="content.textType" />
<input type="hidden" name="writer" value="<%=article.getWriter()%>" id="writer" />
<input type="hidden" name="anum" value="<%=anum%>" id="anum" />
<input type="hidden" name="pageNum" value="<%=pageNum%>" id="pageNum" />
                            ...
                            <div class="nav" role="navigation">
                                <fieldset class="buttons">
                                    ...
                                    <input type="submit" name="create" class="create btn btn-success btn-wide pull-right" value="저장" id="create" />
                                </fieldset>
                            </div>
                        </fieldset>
                    </form>
