		...
		<form method="post" name="writeForm" action="writePro.do"
			...
			<table width="400" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td width="330"><input type="text" size="10" maxlength="10" name="writer" value="${writer}"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="330">
						<!-- 신규 게시물 --> 
						<input type="text" size="40" maxlength="50"name="evtitle"> 
				...
				<tr>
					...
					<td width="330">
						<!-- 신규 게시물 --> <input type="text" size="5" maxlength="5"
						name="tag1"> <input type="text" size="5" maxlength="5"
						name="tag2"> <input type="text" size="5" maxlength="5"
						name="tag3"> <input type="text" size="5" maxlength="5"
						name="tag4"> <input type="text" size="5" maxlength="5"
						name="tag5">
