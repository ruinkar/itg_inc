            ...
            <div class="panel panel-default">
                ...
                <form action="/user/save" method="post" class="form-signup form-user panel-body" id="loginForm" autocomplete="off" >
                    ...
                    <fieldset>
                        ...
                        <input type="password" name="password" class="form-control input-sm" placeholder="비밀번호" required="" value="" id="password" />

                        <input type="text" name="person.email" class="form-control input-sm" placeholder="이메일" required="" value="" id="person.email" />

                        <input type="text" name="person.fullName" class="form-control input-sm" placeholder="이름" required="" value="" id="person.fullName" />

                        <input type="text" name="avatar.nickname" class="form-control input-sm" placeholder="닉네임" required="" value="" id="avatar.nickname" />

                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="person.dmAllowed" value="true" checked="checked"> 이메일 수신 동의
                            </label>
                        </div>
                    </fieldset>
