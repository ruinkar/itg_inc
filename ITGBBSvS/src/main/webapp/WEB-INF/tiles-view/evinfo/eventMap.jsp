...
<script type="text/javascript"
	src="<c:url value="/resources/js/markerclusterer.js"/>"></script>
<script>
	var counter = 0;
	function initialize() {
		$("#map").height($(window).height());
		$("#map-info").height($(window).height());
		...
		function addMarker(data) {
			...
			var infowindow = new google.maps.InfoWindow({
				content : "<img src='"+data.eimg+"' width='115px'/><br><h3>"
						+ data.ename + "</h3>",
				maxWidth : 300
			});
...
<div class="row">
	<!-- <div id="map-container" class="col-xs-8"><div id="map"></div></div> -->
	<!--  
	    -->
	<div id="map" class="col-xs-9"></div><!--  
	--><div id="map-info" class="col-xs-3">
		<dl>
			<h3>제목</h3>
			<dd id="ename"></dd>
			<h3>주최/주관</h3>
